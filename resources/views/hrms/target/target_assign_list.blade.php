                                    ...
                                    <div class="table-responsive">
                                        <table class="table allcp-form theme-warning tc-checkbox-1 fs13">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">{{$tar->employee}}</td>
                                                <td class="text-center">{{$tar->targets}}</td>
                                                <td class="text-center">{{$tar->authority}}</td>
                                                <td class="text-center">{{$tar->assigned_date}}</td>
                                                <td class="text-center">{{$tar->review_date}}</td>
                                                <td class="text-center">
                                                    <div class="btn-group text-right">
                                                        ...
                                                        <ul class="dropdown-menu" role="menu">
                                                            <li>
                                                                <a href="/edit-project-assignment/">Edit</a>
                                                            </li>
                                                            <li>
                                                                <a href="/delete-project-assignment/">Delete</a>

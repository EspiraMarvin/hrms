                                ...
                                <div class="panel-body pn">
                                    <div class="table-responsive">
                                        <div class="panel-body p25 pb10">
                                            ...
                                            {!! Form::open(['action' => ['TargetsController@update',$targetAssign->id],'method' => 'POST','enctype'=>'multipart/form-data','class' => 'form-horizontal','id'=>"custom-form-wizard"]) !!}
                                            ...
                                            <div class="form-group {{ $errors->has('assigned_date') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        ...
                                                        {{Form::date('assigned_date', $targetAssign->assigned_date,['class' => 'select2-single form-control','placeholder'=>'Date of Assignment','required'])}}
                                            ...
                                            <div class="form-group {{ $errors->has('review_date') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        ...
                                                        {{Form::date('review_date', $targetAssign->review_date,['class' => 'select2-single form-control','placeholder'=>'Expected Review Date','required'])}}

            ...
            <div class="topbar-left">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-link">
                        <a href=""> Total Assigned Targets </a>
                    </li>
                    <li class="breadcrumb-current-item"> Total Targets Assignment List</li>
                </ol>
            </div>
        </header>
                        ...
                        <div class="box box-success">
                            <div class="panel">
                                <div class="panel-heading">
                                    <span class="panel-title hidden-xs">  Total Targets Assignment List </span>
                                </div>

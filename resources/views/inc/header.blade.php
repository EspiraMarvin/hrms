...
--}}{{--                @endif--}}{{--
                <li class="dropdown-footer text-center">
                    ...
                    <a id="navbarDropdown" class="nav-link dropdown-toggle offset-2" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                    {{ Auth::user()->name }} <span class="caret"></span>
                    </a>

                    <div style="text-align: center" class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
